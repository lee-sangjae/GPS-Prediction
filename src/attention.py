...
class Decoder(nn.Module):
    ...
    def forward(self, input, hidden, enc_outputs):
        ...
        # rnn_input: [1, 배치 크기, 인코더 히든 차원 * 방향의 수 + 디코더 입력 차원]: 어텐션이 적용된 현재 단어 입력 정보
...
class Seq2Seq(nn.Module):
    ...
    def forward(self, src , trg, is_Train = True,  teacher_forcing_ratio=0.5):
        ...
        return outputs.swapaxes(0,1), attention #[출력 시퀀스, 배치, 출력 변수]
