...
m = models.LSTM(input_size = in_dim, hidden_size = hid_dim, out_dim = out_dim, num_layers = 1, seq_length=w_size).to(device)
...
for e in range(1, num_epoch+1):
    ...
    if min_val_loss > val_loss:
            ...
            torch.save(m.state_dict(),'best_lstm.pth')      
    ...
    with torch.no_grad():
        ...
        dis_diff = pd.DataFrame(columns=['pred1','pred2','pred3'])
        dis_diff['pred1'] = dis1
        dis_diff['pred2'] = dis2
        dis_diff['pred3'] = dis3
