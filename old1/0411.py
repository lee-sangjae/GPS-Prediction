...
x = pd.read_csv('C:/Users/USER/Desktop/YT_data/YT309.csv')
x.columns
...
#341, 377 테스트
train = df[~((df.equ_no=='YT341') | (df.equ_no=='YT377'))].drop('equ_no', axis=1)
test = df[(df.equ_no=='YT341') | (df.equ_no=='YT377')].drop('equ_no', axis=1)
