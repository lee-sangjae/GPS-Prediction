...
for i in range(len(present)):    
    ...
    sns.lineplot(data=v, x=0, y=1, marker='o',ax=ax[0], estimator = None, color='b')
    sns.lineplot(data=v, x=0, y=1, marker='o',ax=ax[1], estimator = None, color='b')
    ...
    sns.lineplot(data=v, x=0, y=1, marker='o',ax=ax[0], estimator = None, color='r')
    sns.lineplot(data=v, x=0, y=1, marker='o',ax=ax[1], estimator = None, color='r')
    
    
    
    #ax.set(xlim=(lat_min,lat_max), ylim = (long_min,long_max))
    ax[0].legend(labels=['present','future' ]) 
    ax[1].legend(labels=['present','future' ]) 
...
sns.scatterplot(data = test[:20], x = 'latitude', y = 'longitude', ax = ax)
ax.set_xlim([min_lat, max_lat])
ax.set_ylim([min_long, max_long])
plt.show()