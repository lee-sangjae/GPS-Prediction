...
with open('model(RNN)_result.pkl', 'rb') as f:
...
for model in model_result:
    ...
    #실험 파라미터 종류 
    for para in md:
        val_loss = md[para]['final_val_loss']
        
        #해당 모델 학습 그래프 
        epoch_train_loss = md[para]['train_loss']
        epoch_val_loss = md[para]['val_loss']
